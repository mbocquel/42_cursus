...
/*   Updated: 2022/12/21 13:59:17 by mbocquel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	get_color_altitude_neg(int e, int col_zero, int col_min)
{
	...
	col = create_trgb(
			(e * get_t(col_min) + (100 - e) * get_t(col_zero)) / 100,
			(e * get_r(col_min) + (100 - e) * get_r(col_zero)) / 100,
			(e * get_g(col_min) + (100 - e) * get_g(col_zero)) / 100,
			(e * get_b(col_min) + (100 - e) * get_b(col_zero)) / 100);
	return (col);
}
