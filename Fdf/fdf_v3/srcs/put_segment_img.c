...
/*   Updated: 2022/12/14 22:27:06 by mbocquel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fdf.h"

void	process_seg_cas1(int *d, t_point *delt, t_point *p, int *inc_y)
{
	if (*d < 0)
		*d += 2 * (*delt).y;
	else
...
void	process_seg_cas2(int *d, t_point *delt, t_point *p, int *inc_x)
{
	if (*d < 0)
		*d += 2 * (*delt).x;
	else
